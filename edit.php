...
if (isset($_POST['submit'])) {
    ...
    if (array_filter($errors)) {
        ...
        //create sql
        $sql = "UPDATE student SET Name='$Name', Roll_No='$Roll_No', Department='$Department', Hostel='$Hostel' WHERE id = $id";
        //csave data 
...
<body>
    <section class="container grey-text">
        <h4 class="center">UPDATE A STUDENT</h4>
        <form action="edit.php?updateid=<?php echo $id; ?>" class="white" method="POST">
